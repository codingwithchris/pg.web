	...
	<div class="container _flex-row-container">
		...
		<div class="audition-content-wrapper _flex-half _l-txt _flex _flex-center-v">
			...
			<div class="audition-content _width-max-600 _r-block _r-txt _plm _prm _pvl">
				...
				<a class="btn -green download-breakdown" style="margin-top: 30px;" href="<?php echo esc_url( home_url('/download/assistance-casting-call/') ); ?>"><i class="fa fa-download"></i><strong>Casting Breakdown</strong></a>
			</div>
		</div>
